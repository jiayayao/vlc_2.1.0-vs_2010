...
static int Create( vlc_object_t *p_this )
{
    ...
    p_filter->p_sys->p_old_data = (uint8_t *)calloc( p_filter->fmt_in.video.i_width *
     (p_filter->fmt_in.video.i_height+1),sizeof(*p_filter->p_sys->p_old_data) );			// sunqueen modify
