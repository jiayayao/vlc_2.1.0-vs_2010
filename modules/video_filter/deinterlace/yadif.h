...
__declspec(align(16)) static const xmm_reg pb_1 = {0x0101010101010101ULL, 0x0101010101010101ULL};			// sunqueen modify
//DECLARE_ASM_CONST(16, const xmm_reg, pw_1) = {0x0001000100010001ULL, 0x0001000100010001ULL};
__declspec(align(16)) static const xmm_reg pw_1 = {0x0001000100010001ULL, 0x0001000100010001ULL};			// sunqueen modify
