...
#define PLANE(f,bits) \
static void Plane##bits##_##f(plane_t *__restrict dst, const plane_t *__restrict src) \
{ \
    const uint##bits##_t *src_pixels = (const uint##bits##_t *)src->p_pixels; \
    uint##bits##_t *__restrict dst_pixels = (uint##bits##_t *)dst->p_pixels; \
...
static void Plane_VFlip(plane_t *__restrict dst, const plane_t *__restrict src)			// sunqueen modify
{
    const uint8_t *src_pixels = src->p_pixels;
    uint8_t *__restrict dst_pixels = dst->p_pixels;			// sunqueen modify
...
// sunqueen modify
#define YUY2(f) \
static void PlaneYUY2_##f(plane_t *__restrict dst, const plane_t *__restrict src) \
{ \
