...
static int Open (vlc_object_t *obj)
{
    ...
    sys->setup = (int (__cdecl *)(void **,char *,unsigned int *,unsigned int *))var_InheritAddress (obj, "amem-setup");			// sunqueen modify
    if (sys->setup != NULL)
    {
        sys->cleanup = (void (__cdecl *)(void *))var_InheritAddress (obj, "amem-cleanup");			// sunqueen modify
    ...
    sys->play = (void (__cdecl *)(void *,const void *,unsigned int,int64_t))var_InheritAddress (obj, "amem-play");			// sunqueen modify
    sys->pause = (void (__cdecl *)(void *,int64_t))var_InheritAddress (obj, "amem-pause");			// sunqueen modify
    sys->resume = (void (__cdecl *)(void *,int64_t))var_InheritAddress (obj, "amem-resume");			// sunqueen modify
    sys->flush = (void (__cdecl *)(void *))var_InheritAddress (obj, "amem-flush");			// sunqueen modify
    sys->drain = (void (__cdecl *)(void *))var_InheritAddress (obj, "amem-drain");			// sunqueen modify
    sys->set_volume = (int (__cdecl *)(void *,float,bool))var_InheritAddress (obj, "amem-set-volume");			// sunqueen modify
    sys->volume = 1.;
    sys->mute = false;
    sys->ready = false;
    if (sys->play == NULL)
