...
static int AVI_ChunkRead_strf( stream_t *s, avi_chunk_t *p_chk )
{
    ...
    switch( p_strh->strh.i_type )
    {
        ...
        case( AVIFOURCC_vids ):
            ...
            p_chk->strf.vids.p_bih = (VLC_BITMAPINFOHEADER *)xmalloc( __MAX( p_chk->common.i_chunk_size,
                                         sizeof( *p_chk->strf.vids.p_bih ) ) );			// sunqueen modify
                                      ...
                                      avi_chunk_t  *p_chk, unsigned i_level )
{
        ...
        p_chk->common.i_chunk_fourcc == AVIFOURCC_LIST )
    {
        _snprintf( &str[i_level * 4], sizeof(str) - 4*i_level,
                 ...
                 p_chk->common.i_chunk_size,
                 p_chk->common.i_chunk_pos );			// sunqueen modify
    }
    else
    {
        _snprintf( &str[i_level * 4], sizeof(str) - 4*i_level,
