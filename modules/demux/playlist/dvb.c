...
static const char *ParseFEC(const char *str)
{
     ...
     const struct fec *f = (const struct fec *)bsearch(str, tab, sizeof (tab) / sizeof(tab[0]),
                                   sizeof (tab[0]), cmp);			// sunqueen modify
...
static const char *ParseModulation(const char *str)
{
     ...
     const struct mod *m = (const struct mod *)bsearch(str, tab, sizeof (tab) / sizeof(tab[0]),
                                   sizeof (tab[0]), cmp);			// sunqueen modify
...
static const char *ParseGuard(const char *str)
{
     ...
     const struct guard *g = (const struct guard *)bsearch(str, tab, sizeof (tab) / sizeof(tab[0]),
                                     sizeof (tab[0]), cmp);			// sunqueen modify
...
static input_item_t *ParseLine(char *line)
{
    ...
    _snprintf(sid_opt, sizeof(sid_opt), "program=%lu", sid);			// sunqueen modify
