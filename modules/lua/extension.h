...
#endif	// start move end
    struct command_t *command;				// sunqueen add
...
static inline int PushCommand( extension_t *ext, int cmd, ... )
{
    va_list args;
    va_start( args, cmd );
    int i_ret = __PushCommand( ext, false, (command_type_e)cmd, args );			// sunqueen modify
    va_end( args );
    return i_ret;
}
static inline int PushCommandUnique( extension_t *ext, int cmd, ... )
{
    va_list args;
    va_start( args, cmd );
    int i_ret = __PushCommand( ext, true, (command_type_e)cmd, args );			// sunqueen modify
    va_end( args );
    return i_ret;
}
