...
static int Open( vlc_object_t *p_this )
{
    ...
    p_stream->p_sys = p_sys = (sout_stream_sys_t *)malloc(sizeof(sout_stream_sys_t));			// sunqueen modify
    ...
    p_sys->p_data = (chromaprint_fingerprint_t *)var_InheritAddress( p_stream, "fingerprint-data" );			// sunqueen modify
    if ( !p_sys->p_data )
    {
