                                    ...
                                    vlc_dictionary_t *p_resp_headers )
{
    ...
    psz_auth = (char *)vlc_dictionary_value_for_key( p_resp_headers,
                                             "WWW-Authenticate" );			// sunqueen modify
    if ( psz_auth == NULL )
    {
...
static int SendSetup( vlc_object_t *p_this )
{
    ...
    /* Get jack type */
    psz_next = (char *)vlc_dictionary_value_for_key( &resp_headers,
                                             "Audio-Jack-Status" );			// sunqueen modify
    while ( SplitHeader( &psz_next, &psz_name, &psz_value ) )
    {
