 ...
 *********************************************************************/
SPrefsCatList::SPrefsCatList( intf_thread_t *_p_intf, QWidget *_parent, bool small_r ) :
                                  QWidget( _parent ), p_intf( _p_intf )		// sunqueen modify
{
    ...
    short icon_height = small_r ? ICON_HEIGHT /2 : ICON_HEIGHT;		// sunqueen modify
...
SPrefsPanel::SPrefsPanel( intf_thread_t *_p_intf, QWidget *_parent,
                          int _number, bool small_r ) : QWidget( _parent ), p_intf( _p_intf )		// sunqueen modify
{
        ...
        START_SPREFS_CAT( Interface, qtr("Interface Settings") );
                    ...
                    == ERROR_SUCCESS )
            {
                ...
                if( RegQueryValueEx( h_key, TEXT("Lang"), NULL, NULL, (LPBYTE) &szData, &len ) == ERROR_SUCCESS ) {
                    langReg = FromWide( (const wchar_t *)szData );			// sunqueen modify
