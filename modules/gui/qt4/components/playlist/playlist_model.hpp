...
public:
    ...
    /* Data structure */
    virtual QVariant data( const QModelIndex &index, /*const*/ int role ) const;			// sunqueen modify
    virtual QVariant headerData( int section, Qt::Orientation orientation,
                         int role = Qt::DisplayRole ) const;
    virtual int rowCount( const QModelIndex &parent = QModelIndex() ) const;
    virtual Qt::ItemFlags flags( const QModelIndex &index ) const;
    virtual QModelIndex index( /*const*/ int r, /*const*/ int c, const QModelIndex &parent ) const;			// sunqueen modify
    ...
    /* Lookups */
    QModelIndex index( /*const*/ int i_id, /*const*/ int c );			// sunqueen modify
