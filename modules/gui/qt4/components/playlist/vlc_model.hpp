 ...
 * $Id: e017014904c8df5a5d3008e6da28e9614013da06 $
 *
...
public:
    ...
    static int columnToMeta( int _column )
    {
        ...
        while( column != _column && meta != COLUMN_END__ )			// sunqueen modify
        {
            meta <<= 1;
            column++;
        }
    ...
    static int columnFromMeta( int meta_col )
    {
        ...
        while( meta != meta_col && meta != COLUMN_END__ )			// sunqueen modify
        {
            meta <<= 1;
            column++;
        }
