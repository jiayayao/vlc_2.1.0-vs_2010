        ...
        switch (expect)
        {
            ...
            case 'a':
                ...
                if (cat == 'a')
                {
                    ...
                    TAB_APPEND ((attribute_t **), p_sdp->mediav[p_sdp->mediac - 1].i_attributes,
                                p_sdp->mediav[p_sdp->mediac - 1].pp_attributes, p_attr);			// sunqueen modify
                    break;
                }
                       ...
                       int i_port )
{
    ...
    INSERT_ELEM ((int *), p_sd->p_sys->pi_fd, p_sd->p_sys->i_fd,
                 p_sd->p_sys->i_fd, i_fd);			// sunqueen modify
    return VLC_SUCCESS;
}
                           ...
                           sap_announce_t *p_announce )
{
    ...
    for( i = 0; i< p_sd->p_sys->i_announces; i++)
    {
        ...
        {
            REMOVE_ELEM( (sap_announce_t **), p_sd->p_sys->pp_announces, p_sd->p_sys->i_announces,
                         i);			// sunqueen modify
            break;
        }
    }
