...
static int Open( vlc_object_t *p_this, enum type_e i_type )
{
    ...
    p_sd->p_sys = p_sys = (services_discovery_sys_t *)calloc( 1, sizeof( *p_sys) );			// sunqueen modify
    if( !p_sys )
        return VLC_ENOMEM;
...
static void input_item_subitem_added( const vlc_event_t * p_event,
                                      void * user_data )
{
    services_discovery_t *p_sd = (services_discovery_t *)user_data;			// sunqueen modify
    services_discovery_sys_t *p_sys = p_sd->p_sys;
                     ...
                     vlc_value_t oldval, vlc_value_t newval, void *p_data )
{
    ...
    services_discovery_t *p_sd = (services_discovery_t *)p_data;			// sunqueen modify
    services_discovery_sys_t *p_sys = p_sd->p_sys;
