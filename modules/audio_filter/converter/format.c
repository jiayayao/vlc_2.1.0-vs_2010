...
static block_t *Fl32toU8(filter_t *filter, block_t *b)
{
    ...
    for (size_t i = b->i_buffer / 4; i--;)
    {
        ...
        if (s <= -128.f)
            ...
            *(dst++) = cover_lroundf(s) + 128;			// sunqueen modify
    }
    b->i_buffer /= 4;
    VLC_UNUSED(filter);
    return b;
...
static block_t *Fl32toS32(filter_t *filter, block_t *b)
{
    ...
    for (size_t i = b->i_buffer / 4; i--;)
    {
        ...
        if (s <= -2147483648.f)
            ...
            *(dst++) = cover_lroundf(s);			// sunqueen modify
    }
    VLC_UNUSED(filter);
    return b;
}
...
static block_t *Fl64toU8(filter_t *filter, block_t *b)
{
    ...
    for (size_t i = b->i_buffer / 8; i--;)
    {
        ...
        if (s <= -128.)
            ...
            *(dst++) = cover_lround(s) + 128;			// sunqueen modify
    }
    b->i_buffer /= 8;
    VLC_UNUSED(filter);
    return b;
...
static block_t *Fl64toS16(filter_t *filter, block_t *b)
{
    ...
    for (size_t i = b->i_buffer / 8; i--;) {
        ...
        if (v >= 32767.)
            ...
            *dst++ = cover_lround(v);			// sunqueen modify
    }
    b->i_buffer /= 4;
    return b;
}
...
static block_t *Fl64toS32(filter_t *filter, block_t *b)
{
    ...
    for (size_t i = b->i_buffer / 8; i--;)
    {
        ...
        if (s <= -2147483648.)
            ...
            *(dst++) = cover_lround(s);			// sunqueen modify
    }
    VLC_UNUSED(filter);
    return b;
}
