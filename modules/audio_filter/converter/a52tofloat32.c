...
static int Open( vlc_object_t *p_this, filter_sys_t *p_sys,
                 const audio_format_t *__restrict input,
                 const audio_format_t *__restrict output )			// sunqueen modify
{
 ...
 *****************************************************************************/
static void Interleave( sample_t *__restrict p_out, const sample_t *__restrict p_in,
                        unsigned i_nb_channels, uint8_t *__restrict pi_chan_table )			// sunqueen modify
{
 ...
 *****************************************************************************/
static void Duplicate( sample_t *__restrict p_out, const sample_t *__restrict p_in )			// sunqueen modify
{
 ...
 *****************************************************************************/
static void Exchange( sample_t *__restrict p_out, const sample_t *__restrict p_in )			// sunqueen modify
{
