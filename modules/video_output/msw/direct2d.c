...
static int Open(vlc_object_t *object)
{
    ...
    D2D1CreateFactory = (HRESULT (__stdcall *)(D2D1_FACTORY_TYPE,const IID &,const D2D1_FACTORY_OPTIONS *,void **))GetProcAddress(sys->d2_dll,
                                               "D2D1CreateFactory");			// sunqueen modify
    ...
    HRESULT hr = D2D1CreateFactory(D2D1_FACTORY_TYPE_SINGLE_THREADED,
                                   ...
                                   &fo,
                                   (void **)&sys->d2_factory);			// sunqueen modify
    if (hr != S_OK) {
