...
#include <d3d9.h>
//#include <dxva2api.h>
#include "../../win32/include/dxva2api.h"			// sunqueen modify
...
static int D3dCreateDevice(vlc_va_dxva2_t *va)
{
    ...
    Create9 = (LPDIRECT3D9 (__stdcall *)(UINT))GetProcAddress(va->hd3d9_dll,
                                     "Direct3DCreate9");			// sunqueen modify
    if (!Create9) {
...
static int D3dCreateDeviceManager(vlc_va_dxva2_t *va)
{
    ...
    CreateDeviceManager9 =
      (HRESULT (__stdcall *)(UINT *,IDirect3DDeviceManager9 **))GetProcAddress(va->hdxva2_dll,
                             "DXVA2CreateDirect3DDeviceManager9");			// sunqueen modify
...
static int DxCreateVideoService(vlc_va_dxva2_t *va)
{
    HRESULT (WINAPI *CreateVideoService)(IDirect3DDevice9 *,
                                         ...
                                         void **ppService);
    CreateVideoService =
      (HRESULT (__stdcall *)(IDirect3DDevice9 *,const IID &,void **))GetProcAddress(va->hdxva2_dll,
                             "DXVA2CreateVideoService");			// sunqueen modify
