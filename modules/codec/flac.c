...
static void Interleave( int32_t *p_out, const int32_t * const *pp_in,
                        const unsigned char *__restrict pi_index, unsigned i_nb_channels,
                        unsigned i_samples, unsigned bits )			// sunqueen modify
{
...
static block_t *Encode( encoder_t *p_enc, block_t *p_aout_buf )
{
    ...
    {
        p_sys->p_buffer = (FLAC__int32 *)
            xrealloc( p_sys->p_buffer, p_aout_buf->i_buffer * sizeof(FLAC__int32) );			// sunqueen modify
