    ...
    else
    {
        ...
        if( !p_sys->b_autodetect_utf8 )
        {
            ...
            *psz_convert_buffer_out++ = '\0';
            ...
            psz_subtitle = (char *)realloc( psz_new_subtitle,
                                    psz_convert_buffer_out - psz_new_subtitle );			// sunqueen modify
            if( !psz_subtitle )
        ...
        else if( *psz_subtitle == '<' )
        {
            ...
            else
            {
                ...
                else if( *psz_stop == '>' )
                {
                    ...
                    _snprintf( psz_match, sizeof(psz_match), "</%s", &psz_subtitle[1] );			// sunqueen modify
