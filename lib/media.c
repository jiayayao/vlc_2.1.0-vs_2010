...
static void input_item_subitem_added( const vlc_event_t *p_event,
                                       void * user_data )
{
    libvlc_media_t * p_md = (libvlc_media_t *)user_data;			// sunqueen modify
...
static void input_item_preparsed_changed(const vlc_event_t *p_event,
                                         void * user_data)
{
    libvlc_media_t *media = (libvlc_media_t *)user_data;			// sunqueen modify
    libvlc_event_t event;
                                   ...
                                   input_item_t *p_input_item )
{
    ...
    p_md = (libvlc_media_t *)calloc( 1, sizeof(libvlc_media_t) );			// sunqueen modify
    if( !p_md )
    {
...
{
    char mrl[16];
    _snprintf( mrl, sizeof(mrl), "fd://%d", fd );			// sunqueen modify
...
libvlc_media_get_tracks_info( libvlc_media_t *p_md, libvlc_media_track_info_t ** pp_es )
{
    ...
    *pp_es = (i_es > 0) ? (libvlc_media_track_info_t *)malloc( i_es * sizeof(libvlc_media_track_info_t) ) : NULL;			// sunqueen modify
...
libvlc_media_tracks_get( libvlc_media_t *p_md, libvlc_media_track_t *** pp_es )
{
    ...
    const int i_es = p_input_item->i_es;
    *pp_es = (i_es > 0) ? (libvlc_media_track_t **)calloc( i_es, sizeof(**pp_es) ) : NULL;			// sunqueen modify
    ...
    for( int i = 0; i < i_es; i++ )
    {
        libvlc_media_track_t *p_mes = (libvlc_media_track_t *)calloc( 1, sizeof(*p_mes) );			// sunqueen modify
        if ( p_mes )
        {
            p_mes->audio = (libvlc_audio_track_t *)malloc( __MAX(__MAX(sizeof(*p_mes->audio),
                                               sizeof(*p_mes->video)),
                                               sizeof(*p_mes->subtitle)) );			// sunqueen modify
        }
