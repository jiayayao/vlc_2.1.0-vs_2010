                                           ...
                                           void * user_data )
{
    ...
    libvlc_media_t * p_md;
    libvlc_media_discoverer_t * p_mdis = (libvlc_media_discoverer_t *)user_data;			// sunqueen modify
    ...
    if( psz_cat )
    {
        p_mlist = (libvlc_media_list_t *)vlc_dictionary_value_for_key( &p_mdis->catname_to_submedialist, psz_cat );			// sunqueen modify
                                       ...
                                       const char * psz_name )
{
    ...
    libvlc_media_discoverer_t *p_mdis = (libvlc_media_discoverer_t *)malloc(sizeof(*p_mdis));			// sunqueen modify
    if( unlikely(!p_mdis) )
    {
...
libvlc_media_discoverer_release( libvlc_media_discoverer_t * p_mdis )
{
    ...
    {
        libvlc_media_list_t * p_catmlist = (libvlc_media_list_t *)vlc_dictionary_value_for_key( &p_mdis->catname_to_submedialist, all_keys[i] );			// sunqueen modify
