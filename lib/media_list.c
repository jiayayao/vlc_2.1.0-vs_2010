...
libvlc_media_list_new( libvlc_instance_t * p_inst )
{
    ...
    p_mlist = (libvlc_media_list_t *)malloc(sizeof(libvlc_media_list_t));			// sunqueen modify
...
void libvlc_media_list_release( libvlc_media_list_t * p_mlist )
{
    ...
    {
        p_md = (libvlc_media_t *)vlc_array_item_at_index( &p_mlist->items, i );			// sunqueen modify
                                     ...
                                     int index )
{
    ...
    p_md = (libvlc_media_t *)vlc_array_item_at_index( &p_mlist->items, index );			// sunqueen modify
