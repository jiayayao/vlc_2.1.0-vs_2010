...
{
    libvlc_media_list_path_t ret = (libvlc_media_list_path_t)xmalloc(sizeof(int));			// sunqueen modify
    ret[0] = -1;
    return ret;
}
...
{
    libvlc_media_list_path_t ret = (libvlc_media_list_path_t)xmalloc(sizeof(int)*2);			// sunqueen modify
    ret[0] = index;
    ret[1] = -1;
    return ret;
}
...
static inline void libvlc_media_list_path_append( libvlc_media_list_path_t * p_path, int index )
{
    ...
    *p_path = (libvlc_media_list_path_t)xrealloc( *p_path, sizeof(int)*(old_depth+2));			// sunqueen modify
...
static inline libvlc_media_list_path_t libvlc_media_list_path_copy_by_appending( const libvlc_media_list_path_t path, int index )
{
    ...
    ret = (libvlc_media_list_path_t)xmalloc( sizeof(int) * (old_depth + 2) );			// sunqueen modify
...
static inline libvlc_media_list_path_t libvlc_media_list_path_copy( const libvlc_media_list_path_t path )
{
    ...
    ret = (libvlc_media_list_path_t)xmalloc( sizeof(int)*(depth+1) );			// sunqueen modify
