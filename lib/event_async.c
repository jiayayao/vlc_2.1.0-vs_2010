...
{
    struct queue_elmt * elmt = (queue_elmt *)malloc(sizeof(struct queue_elmt));			// sunqueen modify
...
{
    p_em->async_event_queue = (libvlc_event_async_queue *)calloc(1, sizeof(struct libvlc_event_async_queue));			// sunqueen modify
...
static void * event_async_loop(void * arg)
{
    libvlc_event_manager_t * p_em = (libvlc_event_manager_t *)arg;			// sunqueen modify
    libvlc_event_listener_t listener;
    libvlc_event_t event;
