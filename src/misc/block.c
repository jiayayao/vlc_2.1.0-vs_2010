...
void block_Init( block_t *__restrict b, void *buf, size_t size )			// sunqueen modify
{
...
static void BlockMetaCopy( block_t *__restrict out, const block_t *in )			// sunqueen modify
{
