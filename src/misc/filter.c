...
{
    filter_t *p_blend = (filter_t *)vlc_custom_create( p_this, sizeof(*p_blend), "blend" );				// sunqueen modify
    if( !p_blend )
        return NULL;
...
{
    video_splitter_t *p_splitter = (video_splitter_t *)vlc_custom_create( p_this,
                                       sizeof(*p_splitter), "video splitter" );				// sunqueen modify
    if( !p_splitter )
        return NULL;
