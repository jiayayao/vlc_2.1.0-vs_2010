...
{
    const vlc_subfn_t *p0 = (const vlc_subfn_t *)a;				// sunqueen modify
    const vlc_subfn_t *p1 = (const vlc_subfn_t *)b;				// sunqueen modify
...
static char **paths_to_list( const char *psz_dir, char *psz_path )
{
    ...
    subdirs = (char **)calloc( i_nb_subdirs + 1, sizeof(char*) );			// sunqueen modify
    if( !subdirs )
        return NULL;
                         ...
                         const char *psz_name_org )
{
    ...
    f_fname_noext = (char *)malloc(i_fname_len + 1);			// sunqueen modify
    f_fname_trim = (char *)malloc(i_fname_len + 1 );			// sunqueen modify
    ...
    result = (vlc_subfn_t *)calloc( MAX_SUBTITLE_FILES+1, sizeof(vlc_subfn_t) ); /* We check it later (simplify code) */			// sunqueen modify
...
//                char psz_path[strlen( psz_dir ) + strlen( psz_name ) + 2];
    ...
    result2 = (char **)calloc( i_sub_count + 1, sizeof(char*) );			// sunqueen modify
