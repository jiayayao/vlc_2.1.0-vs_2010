...
{
    access_t *p_access = (access_t *)vlc_custom_create( p_obj, sizeof (*p_access),
                                            "access" );			// sunqueen modify
...
{
    return p_access->p_input ? (input_thread_t *)vlc_object_hold((vlc_object_t *)p_access->p_input) : NULL;				// sunqueen modify
}
