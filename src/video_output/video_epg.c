                                              ...
                                              int visible_height)
{
    ...
    *last_ptr = vout_OSDEpgSlider(x + visible_width  * EPG_LEFT,
    ...
    char text_start[128];
    char text_end[128];
    _snprintf(text_start, sizeof(text_start), "%2.2d:%2.2d",
             tm_start.tm_hour, tm_start.tm_min);			// sunqueen modify
    _snprintf(text_end, sizeof(text_end), "%2.2d:%2.2d",
             tm_end.tm_hour, tm_end.tm_min);			// sunqueen modify
