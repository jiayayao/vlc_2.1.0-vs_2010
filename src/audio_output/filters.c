...
static filter_t *TryFormat (vlc_object_t *obj, vlc_fourcc_t codec,
                            audio_sample_format_t *__restrict fmt)			// sunqueen modify
{
...
static int aout_FiltersPipelineCreate(vlc_object_t *obj, filter_t **filters,
                                 ...
                                 const audio_sample_format_t *__restrict infmt,
                                 const audio_sample_format_t *__restrict outfmt)			// sunqueen modify
{
...
static int AppendFilter(vlc_object_t *obj, const char *type, const char *name,
                        aout_filters_t *__restrict filters, const void *owner,
                        audio_sample_format_t *__restrict infmt,
                        const audio_sample_format_t *__restrict outfmt)			// sunqueen modify
{
...
aout_filters_t *aout_FiltersNew (vlc_object_t *obj,
                                 const audio_sample_format_t *__restrict infmt,
                                 const audio_sample_format_t *__restrict outfmt,
                                 const aout_request_vout_t *request_vout)			// sunqueen modify
{
