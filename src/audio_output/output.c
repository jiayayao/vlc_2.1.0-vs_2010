...
audio_output_t *aout_New (vlc_object_t *parent)
{
    ...
    audio_output_t *aout = (audio_output_t *)vlc_custom_create (parent, sizeof (aout_instance_t),
                                              "audio output");			// sunqueen modify
 ...
 */
int aout_OutputNew (audio_output_t *aout, audio_sample_format_t *__restrict fmt)			// sunqueen modify
{
    aout_OutputAssertLocked (aout);
