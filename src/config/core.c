...
ssize_t config_GetIntChoices (vlc_object_t *obj, const char *name,
                             int64_t **__restrict values, char ***__restrict texts)			// sunqueen modify
{
    *values = NULL;
    *texts = NULL;
...
static ssize_t config_ListModules (const char *cap, char ***__restrict values,
                                   char ***__restrict texts)			// sunqueen modify
{
    module_t **list;
...
ssize_t config_GetPszChoices (vlc_object_t *obj, const char *name,
                              char ***__restrict values, char ***__restrict texts)			// sunqueen modify
{
    *values = *texts = NULL;
